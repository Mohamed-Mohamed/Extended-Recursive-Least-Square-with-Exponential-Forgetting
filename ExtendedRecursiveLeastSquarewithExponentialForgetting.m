function [ Guz, Gez ] = ExtendedRecursiveLeastSquarewithExponentialForgetting ( u, y, na, nb, d, nc, lambda, Ts, Plot )
% this function is used to estimate the parameter of the system
% by using Extended RLS with Exponential Forgetting  method
...
% Y=phi'*theta_hat
% where :
% phi'=[y(t-1) ... y(t-na) | u(t-1-d) ... u(t-nb-d) | epslon(t-1) ... epslon(t-nc)]
...
%                   2- if Plot = 1  -->  plot needed and Plot(2:4) == figuires number
%% outputs:
